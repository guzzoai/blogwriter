...
const blogFormSchema = z.object({
  ...
  language: z.enum(['English', 'Dutch', 'German', 'French']),
...
export default function BlogForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 dark-form">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <label htmlFor="targetKeyword" className="block text-sm font-medium">
            Target Keyword *
          </label>
          <input
            id="targetKeyword"
      ...
      <div className="space-y-2">
        <label htmlFor="additionalContext" className="block text-sm font-medium">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="firstPerson" className="ml-2 block text-sm">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="storiesExamples" className="ml-2 block text-sm">
          ...
          <div className="flex items-center">
            <input
              ...
              {...register('hook')}
            />
            <label htmlFor="hook" className="ml-2 block text-sm">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="interactiveElement" className="ml-2 block text-sm">
          ...
          <div className="flex items-center">
            <input
              ...
              {...register('faq')}
            />
            <label htmlFor="faq" className="ml-2 block text-sm">
